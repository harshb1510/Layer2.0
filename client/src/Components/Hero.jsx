export default function Hero() {
    return (
        ...
        <section className="relative pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
          <div className="px-4 mx-[50px] max-w-7xl  pl-[20rem] relative z-20">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="mt-5 text-base text-white sm:text-xl">
                Enjoy a seamless payment method from any part of the world. We
                provide a suitable payment method and save you from all worries of
                payment with no hidden charges, prompt service and secured
                platform.
              </p>
              <a
                href="#"
                title=""
                className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-[rgb(202,138,4)] rounded-lg sm:mt-16 hover:bg-yellow-600 focus:bg-yellow-600"
                role="button"
              >
                Get Connected
                <svg
